# fb-marketplace-lead-gen — OfficeX Skill

## Quick Install

```bash
npx skills add OfficeXApp/fb-marketplace-lead-gen
```

> Or install on OfficeX: [officex.app/store/en/app/fb-marketplace-lead-gen](https://officex.app/store/en/app/fb-marketplace-lead-gen)

## About

This repository contains the skill documentation (SKILL.md) for the **fb-marketplace-lead-gen** app on OfficeX.
